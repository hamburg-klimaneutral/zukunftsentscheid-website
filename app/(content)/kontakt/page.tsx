...
export default function ContactPage() {
      ...
      <main>
        ...
        <Block>
          <GridIcon
            ...
            className="max-w-xl"
          >
            Wir geben uns Mühe dein Anliegen so schnell wie es geht zu
            bearbeiten. Wenn du nicht so lange warten möchtest, schau dir an,
  ...
  return (
    <main>
      <Block variant="green">
        <PageHeading
          heading="Schreibe uns eine Nachricht!"
          subheading="Kontakt"
        />
      </Block>
