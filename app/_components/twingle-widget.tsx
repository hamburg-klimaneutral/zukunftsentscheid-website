...
const TWINGLE_BASE_URL = new URL(
  "https://spenden.twingle.de/embed/hamburg-klimaneutral/"
);
  ...
  return (
    <>
      <Script
        ...
        onLoad={() => {
          document
            .querySelector(`#twingle-public-embed-${id} iframe`)
            ?.setAttribute("title", "Spenden Widget");
        }}
      />
      <div
        id={containerId}
